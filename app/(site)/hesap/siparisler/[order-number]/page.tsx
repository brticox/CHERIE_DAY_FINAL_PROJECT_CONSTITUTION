...
import { ArrowLeft, Box, CheckCircle2, Clock3, Truck } from 'lucide-react';
...
function Section({
  ...
  return (
    <section className="rounded-card-lg border border-cherie-lace bg-cherie-ivory p-5 shadow-sm md:p-6">
