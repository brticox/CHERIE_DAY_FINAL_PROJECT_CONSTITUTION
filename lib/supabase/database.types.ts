...
export type Database = {
  public: {
    Tables: {
      ...
      consultations: {
        Row: {
          ...
          service_category: Database['public']['Enums']['service_category'] | null;
    ...
    Views: {
      ...
      digital_products_public: {
        Row: {
          ...
          collection_id: string | null;
          delivery_mode: Database['public']['Enums']['digital_delivery_mode'] | null;
      ...
      product_personalization_fields_public: {
        Row: {
          field_type: Database['public']['Enums']['personalization_field_type'] | null;
          helper_text: string | null;
          id: string | null;
          label: string | null;
          options: Json | null;
      ...
      reviews_public: {
        Row: {
          ...
          rating: number | null;
          subject_id: string | null;
          subject_type: Database['public']['Enums']['review_subject_type'] | null;
          title: string | null;
        };
        Insert: {
          body?: string | null;
      ...
      service_cities_public: {
        Row: {
          ...
          id: string | null;
          notes_tr: string | null;
          travel_fee_model: Database['public']['Enums']['travel_fee_model'] | null;
        };
        Insert: {
          city_name?: string | null;
          city_slug?: string | null;
    ...
    Enums: {
      ...
      checkout_status:
        'open' | 'pending_payment' | 'paid' | 'failed' | 'expired' | 'converted';
      ...
      faq_category:
        ...
        | 'memory';
      favorite_item_type:
        'product' | 'service_package' | 'collection' | 'digital_product';
      fulfillment_status:
      ...
      order_status:
        ...
        | 'cancelled'
        | 'refunded';
      payable_type: 'order' | 'reservation_deposit' | 'reservation_balance' | 'quote';
      ...
      review_subject_type:
        'product' | 'service_package' | 'order' | 'experience' | 'brand';
      search_entity_type:
        | 'product'
        | 'service_package'
        | 'collection'
...
export const Constants = {
  public: {
    Enums: {
      ...
      favorite_item_type: ['product', 'service_package', 'collection', 'digital_product'],
      fulfillment_status: [
        'not_started',
        'preparing',
        'shipped',
      ...
      review_status: ['pending', 'approved', 'rejected', 'hidden'],
      review_subject_type: ['product', 'service_package', 'order', 'experience', 'brand'],
      search_entity_type: [
        'product',
        'service_package',
        'collection',
