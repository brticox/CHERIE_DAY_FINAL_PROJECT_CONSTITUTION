...
const LABELS: Record<string, string> = {
  ...
  resolved: 'Çözüldü',
  dismissed: 'Kanıtla kapatıldı',
  queued: 'Kuyrukta',
  retry_scheduled: 'Yeniden denenecek',
  permanently_failed: 'Kalıcı hata',
  ignored: 'İşlem gerektirmiyor',
  unmatched: 'Eşleşmedi',
  applied: 'Güvenle uygulandı',
  duplicate: 'Mükerrer bildirim',
  invalid_signature: 'İmza doğrulanamadı',
  amount_mismatch: 'Tutar uyuşmazlığı',
  currency_mismatch: 'Para birimi uyuşmazlığı',
  ignored_conflict: 'Çakışma nedeniyle uygulanmadı',
  orphaned: 'Ödemeyle eşleşmedi',
  received: 'Alındı',
  not_submitted: 'Sağlayıcıya gönderilmedi',
  submitted: 'Sağlayıcıya gönderildi',
  succeeded: 'Sağlayıcı onayladı',
  stuck_pending: 'Beklemede takıldı',
  provider_paid_local_unpaid: 'Sağlayıcı ödendi, yerel kayıt bekliyor',
  local_paid_without_evidence: 'Sağlayıcı kanıtı eksik',
  orphaned_event: 'Ödemeyle eşleşmeyen bildirim',
  conflicting_callback: 'Çakışan sağlayıcı bildirimi',
  refund_failure: 'İade sağlayıcı hatası',
  manual_review: 'Elle inceleme gerekli',
  customer_request: 'Müşteri talebi',
  defect: 'Kusur',
  cancellation: 'İptal',
  goodwill: 'Müşteri memnuniyeti',
  other: 'Diğer',
  info: 'Bilgi',
  warning: 'Uyarı',
  error: 'Hata',
  provider: 'Sağlayıcı',
  'paytr.success': 'PayTR başarılı ödeme bildirimi',
  'paytr.failed': 'PayTR başarısız ödeme bildirimi',
  'payment.succeeded': 'Başarılı ödeme bildirimi',
  'payment.failed': 'Başarısız ödeme bildirimi',
  'payment.authorized': 'Ödeme yetkilendirme bildirimi',
  'payment.refunded': 'İade bildirimi',
  checkout_initialized: 'Ödeme sayfası güvenle başlatıldı',
  checkout_initialization_failed: 'Ödeme sayfası başlatılamadı',
...
const EVENTS: Record<string, string> = {
  ...
  payment_attempt_created: 'Ödeme denemesi oluşturuldu',
  payment_initialized: 'Ödeme başlatıldı',
  payment_marked_paid: 'Ödeme doğrulanarak ödendi',
  payment_marked_failed: 'Ödeme başarısız olarak kaydedildi',
  callback_unknown_order: 'Bilinmeyen sipariş bildirimi alındı',
  callback_amount_mismatch: 'Sağlayıcı tutar uyuşmazlığı kaydedildi',
  callback_currency_mismatch: 'Para birimi uyuşmazlığı kaydedildi',
  callback_ignored_conflict: 'Çakışan bildirim güvenle uygulanmadı',
  refund_requested: 'İade talebi oluşturuldu',
  refund_approved: 'İade onaylandı',
  refund_submitted: 'İade sağlayıcıya gönderildi',
  refund_succeeded: 'İade sağlayıcı tarafından tamamlandı',
  refund_failed: 'İade sağlayıcı işlemi başarısız oldu',
  reconciliation_investigating: 'Uzlaştırma incelemeye alındı',
  reconciliation_resolved: 'Uzlaştırma farkı çözüldü',
  reconciliation_dismissed: 'Uzlaştırma farkı kanıtla kapatıldı',
};
